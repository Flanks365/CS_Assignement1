...
// import websocket.chatTest;

@ServerEndpoint(value = "/websocket/chatTest")
public class ChatAnnotation {
    ...
    public void incoming(String message) {
        ...
        String filteredMessage = String.format("%s: %s!", nickname, filterHTML(message.toString()));
