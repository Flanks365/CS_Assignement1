...
public class FileUploadServlet extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      System.out.println(">>>>>" + contentType);//question + uploadDate + fileName);
      Connection con = null;
      try {
      ...
      try {
         ...
         PreparedStatement preparedStatement = con
               .prepareStatement("INSERT INTO questions (ID, Question, ContentPath, content) VALUES (?,?,?,?)");
      ...
      try {
         ...
         ResultSet rs = stmt2.executeQuery("SELECT id, question, contentpath, content FROM questions");
         rs.next();
